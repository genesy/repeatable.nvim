...
---Saves the state in the global _G.Repeatable.state object.
---
---@private
function state:save()
    log.debug("state.save", "saving state globally to _G.Repeatable.state")

    _G.Repeatable.state = self
end
...
---Whether the Repeatable is enabled or not.
---
